...
import com.op.bt.beneficiarypayments.UI.RegisterUser;
...
public abstract class DialogUtils {
    ...
    public static void showDeleteDialog(final Context context) {
        ...
        new AlertDialog.Builder(context)
                ...
                .setMessage(context.getString(R.string.deleteDialog))
               // .setIcon(R.drawable.error_icon)
                        ...
                        new AlertDialog.Builder(context)
                                ...
                                .setItems(R.array.nfcCmdOptions, new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        Intent nfcIntent = new Intent(context, RegisterUser.class).addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
